...
import UDevelopment from "./UDevelopment";
        ...
        <div className="grid grid-cols-1 h-3/4 md:grid-cols-2">
          <div className="flex flex-col w-full h-full gap-3 py-24 md:justify-between">
            <div className="max-w-2xl text-xl md:text-3xl">
              <p>
                We craft meaningful brand identities that reflect who you are,
                connect with the right people, and give you the confidence to
                show up as your best self — online and off.
              </p>
            </div>
